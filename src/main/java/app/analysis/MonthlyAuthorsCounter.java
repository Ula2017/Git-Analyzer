...
public class MonthlyAuthorsCounter extends AbstractAnalyzerModule {
    ...
    public String generateFile(List<CommitDetails> commitDetails, DateTime from, DateTime to) throws Exception {
